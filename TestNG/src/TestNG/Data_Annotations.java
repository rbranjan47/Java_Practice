...
public class Data_Annotations 
{
	...
	//System.out.println(driver.findElement(By.xpath("//h3[contains (text(),'Samsung Galaxy S7 Edge G935 32GB GSM Unlocked Android Smartphone AT&T T-Mobile')]/../../div[3]/div[1]/span")).getText());
	 
	String price=driver.findElement(By.xpath("//span[@class='s-item__price']/../../../../div[2]/div[3]/div[1]")).getText();
